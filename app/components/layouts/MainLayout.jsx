                        ...
                        <div className="products products-grid-wrapper">
                            <div className="row">
                                ...
                                <div className="col-md-4 col-sm-4 col-xs-12">
                                    ...
                                    <a href="products-grid.html#" title="Gin Lane Greenport Cotton Shirt">Gin Lane Greenport Cotton Shirt</a>
                                </h2>
                                ...
                                <div className="col-md-4 col-sm-4 col-xs-12">
                                    ...
                                    <div className="product product-grid">
                                        <div className="product-media">
                                            <div className="product-thumbnail">
                                                <a href="product-fullwidth.html" title="">
                                                    <img src="img/samples/products/grid/2.jpg" alt="" className="current"/>
                                                    <img src="img/samples/products/index/clothing/2.jpg" alt=""/>
                                                </a>
                                            </div>
                                ...
                                <div className="col-md-4 col-sm-4 col-xs-12">
                                    ...
                                    <div className="product product-grid">
                                        <div className="product-media">
                                            <div className="product-thumbnail">
                                                <a href="product-fullwidth.html" title="">
                                                    <img src="img/samples/products/grid/3.jpg" alt="" className="current"/>
                                                    <img src="img/samples/products/index/clothing/2.jpg" alt=""/>
                                                </a>
                                            </div>
                                            ...
                                            <span className="product-label sale">
                                    <span>sale</span>
                                            </span>
                                ...
                                <div className="col-md-4 col-sm-4 col-xs-12">
                                    ...
                                    <div className="product product-grid">
                                        <div className="product-media">
                                            <div className="product-thumbnail">
                                                <a href="product-fullwidth.html" title="">
                                                    <img src="img/samples/products/grid/4.jpg" alt="" className="current"/>
                                                    <img src="img/samples/products/index/clothing/2.jpg" alt=""/>
                                                </a>
                                            </div>
                                ...
                                <div className="col-md-4 col-sm-4 col-xs-12">
                                    ...
                                    <div className="product product-grid">
                                        <div className="product-media">
                                            <div className="product-thumbnail">
                                                <a href="product-fullwidth.html" title="">
                                                    <img src="img/samples/products/grid/5.jpg" alt="" className="current"/>
                                                    <img src="img/samples/products/index/clothing/2.jpg" alt=""/>
                                                </a>
                                            </div>
                                            ...
                                            <span className="product-label new">
                                    <span>new</span>
                                            </span>
                                ...
                                <div className="col-md-4 col-sm-4 col-xs-12">
                                    ...
                                    <div className="product product-grid">
                                        <div className="product-media">
                                            <div className="product-thumbnail">
                                                <a href="product-fullwidth.html" title="">
                                                    <img src="img/samples/products/grid/6.jpg" alt="" className="current"/>
                                                    <img src="img/samples/products/index/clothing/2.jpg" alt=""/>
                                                </a>
                                            </div>
                                ...
                                <div className="col-md-4 col-sm-4 col-xs-12">
                                    ...
                                    <div className="product product-grid">
                                        <div className="product-media">
                                            <div className="product-thumbnail">
                                                <a href="product-fullwidth.html" title="">
                                                    <img src="img/samples/products/grid/7.jpg" alt="" className="current"/>
                                                    <img src="img/samples/products/index/clothing/2.jpg" alt=""/>
                                                </a>
                                            </div>
                                ...
                                <div className="col-md-4 col-sm-4 col-xs-12">
                                    ...
                                    <div className="product product-grid">
                                        <div className="product-media">
                                            <div className="product-thumbnail">
                                                <a href="product-fullwidth.html" title="">
                                                    <img src="img/samples/products/grid/8.jpg" alt="" className="current"/>
                                                    <img src="img/samples/products/index/clothing/2.jpg" alt=""/>
                                                </a>
                                            </div>
                                ...
                                <div className="col-md-4 col-sm-4 col-xs-12">
                                    ...
                                    <div className="product product-grid">
                                        <div className="product-media">
                                            <div className="product-thumbnail">
                                                <a href="product-fullwidth.html" title="">
                                                    <img src="img/samples/products/grid/9.jpg" alt="" className="current"/>
                                                    <img src="img/samples/products/index/clothing/2.jpg" alt=""/>
                                                </a>
                                            </div>
