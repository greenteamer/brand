				...
				<div className="container">
					<div className="awemenu-container">
												...
												<div className="header-account">
													<div className="header-account-avatar">
														<a href="products-grid.html#" title="">
															<img src="/static/brand/img/samples/avatars/customers/1.jpg" alt="" className="img-circle" />
														</a>
													</div>
												...
												<ul className="whishlist">
													...
													<li>
														<div className="whishlist-item">
															<div className="product-image">
																<a href="products-grid.html#" title="">
																	<img src="/static/brand/img/samples/products/cart/1.jpg" alt=""/>
																</a>
															</div>
													...
													<li>
														<div className="whishlist-item">
															<div className="product-image">
																<a href="products-grid.html#" title="">
																	<img src="/static/brand/img/samples/products/cart/2.jpg" alt=""/>
																</a>
															</div>
													...
													<li>
														<div className="whishlist-item">
															<div className="product-image">
																<a href="products-grid.html#" title="">
																	<img src="/static/brand/img/samples/products/cart/3.jpg" alt=""/>
																</a>
															</div>
						...
						<div className="awe-logo">
							<a href="/" title="">
								<img src="/static/brand/img/logo.png" alt=""/>
							</a>
						</div>
												...
												<div className="row">
													...
													<div className="col-lg-3">
														<ul className="sublist">
															<li>
																<a href="products-grid.html#" title="">Blazers &amp; Vests</a>
															</li>
															<li>
																<a href="products-grid.html#" title="">Graphics Tees</a>
															</li>
															<li>
																<a href="products-grid.html#" title="">Jeans</a>
															</li>
															<li>
																<a href="products-grid.html#" title="">Jackets &amp; Outerwear</a>
															</li>
															<li>
																<a href="products-grid.html#" title="">Pants</a>
															</li>
														</ul>
													</div>
													...
													<div className="col-lg-3">
														<ul className="sublist">
															<li>
																<a href="products-grid.html#" title="">Shirts</a>
															</li>
															<li>
																<a href="products-grid.html#" title="">Short &amp; Swim</a>
															</li>
															<li>
																<a href="products-grid.html#" title="">Tees</a>
															</li>
													...
													<div className="col-lg-3">
														<div className="awe-media inline margin-bottom-25">
															<div className="awe-media-image">
																<a href="products-grid.html#" title="">
																	<img src="/static/brand/img/samples/menu/trending-shop.jpg" alt=""/>
																</a>
															</div>
														...
														<div className="awe-media inline">
															<div className="awe-media-image">
																<a href="products-grid.html#" title="">
																	<img src="/static/brand/img/samples/menu/shirt-shop.jpg" alt=""/>
																</a>
